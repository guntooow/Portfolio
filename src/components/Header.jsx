...
function Header() {
    return (
        <header className="font-grotesk z-50 pl-32 pr-32 flex fixed backdrop-blur-lg gap-96 p-8 bg-gray-200 bg-opacity-90 shadow-violet-300  shadow-lg w-screen justify-between">
            <div className="flex text-purple-600 gap-3 font-bold text-xl opacity-90 cursor-pointer transition-all hover:opacity-100">
                <Logo className="stroke-purple-600 scale-150" />
                <p>João_</p>
            </div>
            <ul className="flex gap-8 right-0 text-purple-700 font-semibold">
                <li className="opacity-90 hover:opacity-100 transition-all flex gap-2">
                    <Sobre className="hover fill-purple-200" />
                    <a href="#sobre">Sobre mim</a>
                </li>
                <li className="opacity-90 hover:opacity-100 flex gap-2">
